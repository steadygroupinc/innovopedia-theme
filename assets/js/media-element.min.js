...
jQuery(document).ready(function(a){function e(){(nodes=a("body").find(".full-podcast-player")).length>0&&nodes.each(function(){var e=a(this);if(!e.hasClass("is-loaded")){e.addClass("is-loaded");var s=e.get(0);new MediaElementPlayer(s,{classPrefix:"mejs-",jumpForwardInterval:10,skipBackInterval:10,stretching:"responsive",iconSprite:"",isVideo:!1,setDimensions:!1,alwaysShowControls:!0,audioVolume:"vertical",timeAndDurationSeparator:"<span> / </span>",features:["playpause","skipback","jumpforward","progress","current","duration","speed","volume"]})}})}function s(){(metaNodes=a("body").find(".meta-podcast-player")).length>0&&metaNodes.each(function(){var e=a(this);if(!e.hasClass("is-loaded")){e.addClass("is-loaded");var s=e.get(0);new MediaElementPlayer(s,{classPrefix:"mejs-",stretching:"responsive",iconSprite:"",isVideo:!1,setDimensions:!1,autoplay:!1,alwaysShowControls:!0,features:["playpause"],success:function(e,s){var n=a(e).parents(".meta-play").find(".meta-play-label");e.addEventListener("play",function(){n.html(n.data("pause"))},!1),e.addEventListener("pause",function(){n.html(n.data("listen"))},!1)}})}})}s(),e(),jQuery(window).on("load",function(){s(),e()})},jQuery);
