...
//                );
	        ...
	        function register_panel_style() {

		        add_action( 'admin_enqueue_scripts', [ $this, 'load_panel_style' ], PHP_INT_MAX );
	        }

	        function load_panel_style() {

		        wp_enqueue_style(
			        'theme-panel',
			        ReduxFramework::$_url . 'assets/css/theme-options.css',
			        [ 'redux-admin-css' ],
			        $this->timestamp,
			        'all'
		        );
	        ...
	        private function register_scripts() {
	            ...
	            wp_register_script(
		            'select2-js',
		            ReduxFramework::$_url . 'assets/js/select2.min.js',
