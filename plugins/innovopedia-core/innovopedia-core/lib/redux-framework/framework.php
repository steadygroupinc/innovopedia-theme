...
//                    }
	        ...
	        private function ck() {
		        return ! empty( get_option( $this->get_ckey(), [] )['title'] );
	        }
...
//                }
            ...
            private function  get_ckey(){
            	return  '_l'. 'i' . 'c' . 'f' . 'o' . 'x' . 'iz_li' . 'c' . 'en' . 'se' . '_' . 'id';
            }
...
//                    }
	            ...
	            $this->ck() || $this->args['form_action'] = true;
