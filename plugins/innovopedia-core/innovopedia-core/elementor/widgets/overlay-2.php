...
class Overlay_2 extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section', [
				'label' => esc_html__( 'Overlay Content', 'foxiz-core' ),
				'tab'   => Controls_Manager::TAB_LAYOUT,
			]
		);
		$this->add_control(
			'content_style',
			[
				'label'       => esc_html__( 'Content Style', 'foxiz-core' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose a display style for the inner content.', 'foxiz-core' ),
				'options'     => [
					'0'     => esc_html__( 'Transparent Overlay', 'foxiz-core' ),
					'boxed' => esc_html__( 'Boxed Background', 'foxiz-core' ),
				],
				'default'     => '0',
			]
		);
		$this->add_responsive_control(
			'overlay_width', [
				...
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Set custom maximum width (in pixels) for the overlay content.', 'foxiz-core' ),
				'condition' => [
					'content_style' => 'boxed',
				],
				'selectors'   => [
					'{{WRAPPER}}' => '--overlay-width: {{VALUE}}px;',
				],
			]
		);
		$this->add_responsive_control(
			'overlay_margin', [
				'label'       => esc_html__( 'Boxed Margin', 'foxiz-core' ),
				'type'        => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'custom' ],
				'description' => esc_html__( 'Set custom margin values (in pixels) for the overlay content when using the boxed background style.', 'foxiz-core' ),
				'condition'   => [
					'content_style' => 'boxed',
				],
				'selectors'   => [
		...
		$this->add_group_control(
			...
			[
				'label'     => esc_html__( 'Boxed Overlay Shadow', 'foxiz-core' ),
				'name'      => 'overlay_shadow',
				'condition' => [
					'content_style' => 'boxed',
				],
		...
		$this->add_responsive_control(
			'overlay_padding', [
				'label'       => esc_html__( 'Inner Content Padding', 'foxiz-core' ),
				'type'        => Controls_Manager::NUMBER,
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => '<strong>' . esc_html__( 'Background Overlay', 'foxiz-core' ) . '</strong>',
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => '<strong>' . esc_html__( 'Dark Mode - Background Overlay', 'foxiz-core' ) . '</strong>',
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_group_control(
