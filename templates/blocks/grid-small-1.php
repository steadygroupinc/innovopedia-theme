...
if ( ! function_exists( 'foxiz_get_grid_small_1' ) ) {
	function foxiz_get_grid_small_1( $settings = [], $_query = null ) {
		...
		$settings = foxiz_get_design_standard_block( $settings, 'grid_small_1' );
		...
		if ( ! $_query->have_posts() ) {
			...
			foxiz_loop_grid_small_1( $settings, $_query );
...
if ( ! function_exists( 'foxiz_loop_grid_small_1' ) ) {
	function foxiz_loop_grid_small_1( $settings, $_query ) {
